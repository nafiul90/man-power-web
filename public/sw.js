// Man Power service worker — bumps the version to invalidate old caches.
const CACHE_VERSION = "v1";
const APP_SHELL_CACHE = `Man Power-shell-${CACHE_VERSION}`;
const RUNTIME_CACHE = `Man Power-runtime-${CACHE_VERSION}`;
